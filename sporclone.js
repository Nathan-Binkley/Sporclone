...
function start()
{
    if (!playing)
    {
        ...
        //unblur
        document.getElementById("answers").setAttribute("class", "unhide");
        //only for memes
...
function start2()
{
    if (!playing)
    {
        ...
        document.getElementById("answers").setAttribute("class", "unhide");
        //only for memes
        document.getElementById("answers2").setAttribute("class", "unhide");
...
function postMemePic() {
        document.getElementById("perfection").innerHTML = "<img src='img/notBad.jpg' alt='Not Bad'>";
}